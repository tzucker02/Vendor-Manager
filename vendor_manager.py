...
class DatabaseManager:
    ...
    def add_payment_method(self, method_name, account_last_four):
        self.cursor.execute("INSERT INTO payment_methods (method_name, account_last_four) VALUES (?, ?)", 
...
class VendorApp(ctk.CTk):
    ...
    def open_scanner(self):
        ...
        if file_path:
            try:
                ...
                ctk.CTkButton(result_window, text="Use as Vendor Input", 
                              command=lambda: self.populate_from_scan(text, result_window)).pack(pady=10)
    ...
    def populate_from_scan(self, text, window):
        # Logic to parse text and auto-fill vendor form would go here
